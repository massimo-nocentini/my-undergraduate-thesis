...
\begin{quotation}
  ...
  $F$. Inoltre, sia $u$ l'antenato comune tale che $numero$ sia minimo
  tra tutti gli altri antenati comuni, allora $u \in C$.
\end{quotation}
...
componente fortemente connessa, esiste un cammino $\pi$ tale che $v
\rightarrow^{*} w$ (e anche un cammino $w \rightarrow^{*} v$ per la
